...
if __name__ == '__main__':
    ...
    parser.add_argument('--models', action='store', 
                    type=str, nargs='*')
    parser.add_argument('--scen_train', action='store', 
                    type=str, nargs='*', default=['historical','ssp585','ssp126'])
    ...
    fit_tools.fit_mean_response(\
                                ...
                                models, scen_train, data_tas, idx_l, wgt_l, linreg=False, 
                                weighted=False, gam_arch=gam_arch
                               )

    fit_tools.fit_mean_response(\
                                load_data.get_config()['dir_output_hurs'], 
                                models, scen_train, data_rh, idx_l, wgt_l, linreg=False, 
                                weighted=False, gam_arch=gam_arch
                               )
